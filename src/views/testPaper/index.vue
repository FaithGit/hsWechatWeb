<template>
  <div class="testPaper">
    ...
    <div>
      试卷名称：
      <el-input class="seachInput" v-model="examName" placeholder="请选择输入关键字" clearable></el-input>
      考试人员：
    ...
    <!-- 查看试卷 -->
    <el-dialog v-if="examVisible" title="查看试卷" :append-to-body="true" :visible="examVisible" width="70%"
      ...
      <el-table
        ...
        <el-table-column align="right" width="160">
          ...
          <template slot-scope="scope">
            <div style="text-align:center" v-if="scope.row.questionImg">
    ...
    <!-- 导入题目 -->
    <el-dialog title="导入题目" v-if="timuVisible" :append-to-body="true" :visible="timuVisible" width="30%"
    ...
    <!-- 导入试卷 -->
    <el-dialog title="导入试卷" v-if="shijuanVisible" :append-to-body="true" :visible="shijuanVisible" width="50%"
      ...
      <el-form ref="form1" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="考试人员" prop="licensedStatus">
          <el-select v-model="form.licensedStatus" placeholder="请选择考试人员">
            <el-option v-for="item in licensedStatusoptions" :key="item.value+'考试人员'" :label="item.label"
              :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="试卷难度" prop="examDifficultyCode">
          <el-select v-model="form.examDifficultyCode" placeholder="请选择试卷难度">
            <el-option v-for="item in examDifficultyCodeList" :key="item.value+'考试难度'" :label="item.label"
              :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="试卷附件">
          <el-upload style="width:30%" class="upload-demo" action="#" :on-remove="upRemove" :limit="1"
            :file-list="uplist" accept=".xlsx" :auto-upload="false" :on-change="upChangeFile">
            <el-button size="small" type="primary">点击上传</el-button>
            <div slot="tip" class="el-upload__tip">限单个xlsx文件</div>
          </el-upload>
        </el-form-item>
    ...
    <!-- 随机生成试卷 -->
    <el-dialog title="随机生成试卷" v-if="sjVisible" :append-to-body="true" :visible="sjVisible" width="50%"
