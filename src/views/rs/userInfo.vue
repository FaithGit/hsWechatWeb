  ...
  <div class="testPaper">
    ...
    >
      <el-form ref="form1" :model="form" label-width="140px" :rules="rules">
        ...
        <el-form-item label="入职渠道备注">
          <el-input
            v-model="form.entryRemark"
            placeholder="请输入入职渠道备注"
          />
        </el-form-item>
        ...
        <el-form-item label="离职时间" v-if="form.status == 2">
          <el-date-picker
    ...
    edit(e) {
      getUserInfoDetail({
        ...
        this.form = {
          ...
          entryRemark: retData.entryRemark,
          quitTime: retData.quitTime,
        };
    ...
    editPeople() {
      ...
      this.$refs.form1.validate((valid) => {
        if (valid) {
          ...
          if (quitTime != "") {
            quitTime = moment(this.form.quitTime).format("YYYY-MM-DD");
          } else {
            quitTime = "";
          }
          ...
          newObj = {
            ...
            telephone: this.form.telephone,
            userName: this.form.userName,
            entryRemark: this.form.entryRemark,
            quitTime: quitTime,
            idnumFiles: _idnumFiles,
            userImages: _userImages,
            educationFiles: _educationFiles,
          };
          updateUserInfo(newObj)
            .then((res) => {
              console.log(res);
              this.$notify({
                type: "success",
