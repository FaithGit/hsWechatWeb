<template>
  <div class="testPaper">
    ...
    <div>
      视频名称：
      <el-input class="seachInput" v-model="videoName" placeholder="请选择输入关键字" clearable></el-input>
      学习人员：
    ...
    <!-- 导入视频 -->
    <el-dialog title="导入视频" v-if="shijuanVisible" :append-to-body="true" :visible="shijuanVisible" width="50%"
      :close-on-click-modal="false" @close="shijuanVisible=false">
      <el-form ref="form1" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学习人员" prop="licensedStatus">
          <el-select v-model="form.licensedStatus" placeholder="请选择学习人员">
            <el-option v-for="item in licensedStatusoptions" :key="item.value+'学习人员'" :label="item.label"
              :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="视频简介" prop="introduction">
          <el-input type="textarea" placeholder="请输入视频简介" v-model="form.introduction" rows="4">
          </el-input>
        </el-form-item>
        <el-form-item label="封面照片">
          <el-upload style="width:30%" class="upload-demo" action="#" list-type="picture" :on-remove="upRemove2"
            :limit="1" :file-list="uplist2" accept=".jpg,.jpeg" :auto-upload="false" :on-change="upChangeFile2">
            <el-button size="small" type="primary">点击上传</el-button>
            <div slot="tip" class="el-upload__tip">限单个jpg/jpeg文件</div>
          </el-upload>
        </el-form-item>
        <el-form-item label="视频附件">
          <el-upload style="width:30%" class="upload-demo" action="#" :on-remove="upRemove" :limit="1"
            :file-list="uplist" accept=".mp4" :auto-upload="false" :on-change="upChangeFile">
            <el-button size="small" type="primary">点击上传</el-button>
    ...
    <el-dialog title="查看视频" v-if="checkVisible" :append-to-body="true" :visible="checkVisible" width="50%"
      :close-on-click-modal="false" @close="checkVisible=false">
      <el-form ref="form1" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="视频名称" prop="videoName">
        ...
        <el-form-item label="视频简介" prop="introduction">
          <el-input type="textarea" placeholder="请输入视频简介" :readonly="true" v-model="form.introduction" rows="4">
          </el-input>
        </el-form-item>
        <el-form-item label="封面照片">
